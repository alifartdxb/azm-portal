...
ensureDir('src/pages/admin/projects');
...
fs.writeFileSync('src/pages/admin/projects/AdminProjects.tsx', projectsList);

// AdminProjectForm.tsx
const projectForm = `import React, { useState, useEffect } from 'react';
...
fs.writeFileSync('src/pages/admin/projects/AdminProjectForm.tsx', projectForm);

// AdminFAQs.tsx
const faqsList = `import React, { useState, useEffect } from 'react';
...
fs.writeFileSync('src/pages/admin/AdminFAQs.tsx', faqsList);

// AdminCareers.tsx
const careersList = `import React, { useState, useEffect } from 'react';
...
fs.writeFileSync('src/pages/admin/AdminCareers.tsx', careersList);
